...
<table width="959" height="150" border="1">
  ...
  <tr>
    ...
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[undeliv1]"?></font></div></td>
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[sisa1]"?></font></div></td>
  </tr>
  <tr>
   <td height="25"><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[nm_fg2]"?></font></div></td>
    ...
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[undeliv2]"?></font></div></td>
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[sisa2]"?></font></div></td>
  </tr>
  <tr>
   <td height="25"><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[nm_fg3]"?></font></div></td>
    ...
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[undeliv3]"?></font></div></td>
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[sisa3]"?></font></div></td>
  </tr>
  <tr>
   <td height="25"><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[nm_fg4]"?></font></div></td>
    ...
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[undeliv4]"?></font></div></td>
    <td><div align="center"><font face="Courier New, Courier, mono"><?php echo "$r[sisa4]"?></font></div></td>
  </tr>
</table>
