...
<table rules="all" width="839" border="2<strong></strong>" align="center">
  <tbody>
    ...
    <tr>
      <td height="20" align="left" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif"><input type="text" size="60" value="<?php echo "$r1[nm_fg1]"?>" ></span></td>
    ...
    <tr>
      <td height="20" align="left" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif"><input type="text" size="60" value="<?php echo "$r1[nm_fg2]"?>" ></span></td>
    ...
    <tr>
      <td height="20" align="left" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif"><input type="text" size="60" value="<?php echo "$r1[nm_fg3]"?>" ></span></td></span></td>
