...
<section class="content">
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
              $query = mysql_query("INSERT INTO salesorder VALUES ('','$_POST[no_so]','$_POST[so_ext]','$_POST[segel]','$_POST[tgl]','$_POST[nm_cust]'
			  ,'$_POST[alamat]','$_POST[tlp]','$_POST[nm_fg1]','$_POST[qty1]','$_POST[undeliv1]','$_POST[sisa1]','$_POST[nm_fg2]','$_POST[qty2]'
			  ,'$_POST[undeliv2]','$_POST[sisa2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[undeliv3]','$_POST[sisa3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[undeliv4]','$_POST[sisa4]','$_POST[nm_fg5]','$_POST[qty5]','$_POST[undeliv5]','$_POST[sisa5]')");
			  
		   $query .= mysql_query("INSERT INTO so VALUES ('','$_POST[do1]','$_POST[time]','$_POST[no_so]','$_POST[so_ext]','$_POST[segel]','$_POST[nm_cust]'
			  ,'$_POST[alamat]','$_POST[tlp]','$_POST[tgl]','$_POST[mobil]','$_POST[supir]','$_POST[nm_fg1]','$_POST[qty1]','$_POST[exp1]','$_POST[nm_fg2]','$_POST[qty2]'
			  ,'$_POST[exp2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[exp3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[exp4]','$_POST[nm_fg5]','$_POST[qty5]','$_POST[exp5]')");
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
                   ...
                   <div class="form-group">Nomor Order
					  ...
					  <div class="form-group">Nomor PO External
                    <input type="text" class="form-control" id="so_ext" name="so_ext"  placeholder="Silahkan Masukan No PO"/>
					</div>
					  
					   <div class="form-group">Nomor Segel
                    <input type="text" class="form-control" id="segel" name="segel"  placeholder="Silahkan Masukan No Kunci Segel" required data-fv-notempty-message="Tidak boleh kosong" maxlength="10">
					</div>
...
";    
 ...
 <div class="form-group">
                     <select class="form-control select2" id="nm_fg5" name="nm_fg5" style="width: 100%;" s>
                      <option value="" >--- Silahkan Pilih ---</option>
                      <?php
                $query = mysql_query("SELECT * FROM  stok_fg order by id asc");
                while ($row = mysql_fetch_array($query)) {
           ...
           <input type="text" class="form-control" id="qty5" name="qty5" onKeyUp="sum5();" placeholder="input dalam satuan Sak" >
           <input type="hidden"  class="form-control" id="undeliv5" name="undeliv5" onKeyUp="sum5();" placeholder="input dalam satuan Sak" >
             <input type="hidden"  class="form-control" id="sisa5" name="sisa5" onKeyUp="sum5();" placeholder="input dalam satuan Sak" >
                    </div>
	...
	function changeValue(no_form){ 
		...
		document.getElementById('pic').value = frm[no_form].pic; 
               ...
               <script>
              function sum5() {
              var txt1 = document.getElementById('qty5').value;
              var txt2 = document.getElementById('undeliv5').value;
              var txt3 = document.getElementById('sisa5').value;
              
              var result1 =parseInt(txt1)*0;
                  if (!isNaN(result1)) {
                  document.getElementById('undeliv5').value = result1;
              }
              
              var result2 = 0-(txt1);
                  if (!isNaN(result2)) {
                  document.getElementById('sisa5').value = result2;
              }
	  ...
	  mysql_query("UPDATE salesorder SET no_so='$_POST[no_so]', so_ext='$_POST[so_ext]',segel='$_POST[segel]',tgl='$_POST[tgl]',nm_cust='$_POST[nm_cust]',alamat='$_POST[alamat]',pic='$_POST[pic]',nm_fg1='$_POST[nm_fg1]',qty1='$_POST[qty1]',undeliv1='$_POST[undeliv1]',sisa1='$_POST[sisa1]'
		...
		,nm_fg4='$_POST[nm_fg4]',qty4='$_POST[qty4]',undeliv4='$_POST[undeliv4]',sisa4='$_POST[sisa4]',nm_fg5='$_POST[nm_fg5]',qty5='$_POST[qty5]',undeliv4='$_POST[undeliv5]',sisa5='$_POST[sisa5]' WHERE id='$_POST[id]'");
