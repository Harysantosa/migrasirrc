...
<section class="content">
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['update'])) {
        ...
        nm_fg3='$_POST[nm_fg4]',qty3='$_POST[qty4]',exp3='$_POST[exp4]',
				nm_fg4='$_POST[nm_fg5]',qty4='$_POST[qty5]',exp4='$_POST[exp5]' WHERE id='$_POST[id]'");
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">		  
                      ...
                      <label for="exampleInputEmail1">data surat jalan</label>
					 ...
					 <div class="form-group">
                      ...
                      <option value="ENGKEL B 9125 FCL">ENGKEL B 9125 FCL</option>

<option value="DOUBLE ENGKEL B 9922 FXV">DOUBLE ENGKEL B 9922 FXV</option>

<option value="ENGKEL 9102 FXW">ENGKEL 9102 FXW</option>

<option value="DOUBLE ENGKEL B 9664 FCG">DOUBLE ENGKEL B 9664 FCG</option>
						 </optgroup>
                      </select>
					  </div>
...
<option value="mulkin">mulkin</option>
<option value="wahyudin">wahyudin</option>
					 ...
					 <input type ="text" class="form-control" id="date" name="exp1"  value= "<?php echo $d['exp1'];?>"> 
					</div>
					...
					<div class="form-group">Produk2
					 ...
					 <input type ="text"  class="form-control" id="date" name="exp2" value= "<?php echo $d['exp2'];?>"> 
					</div>
					...
					<div class="form-group">Produk3
					 ...
					 <input type ="text"  class="form-control" id="date" name="exp3" value= "<?php echo $d['exp3'];?>"> 
					</div>
					...
					<div class="form-group">Produk4
					 ...
					 <input type ="text"  class="form-control" id="date" name="exp4" value= "<?php echo $d['exp4'];?>"> 
					</div>i
					  
             <div class="form-group">Produk5
                       <input readonly class="form-control" id="nm_fg5" name="nm_fg5" value= "<?php echo $d['nm_fg5'];?>">  
           <input readonly class="form-control" id="qty5" name="qty5" value= "<?php echo $d['qty5'];?>">
           <input type ="text"  class="form-control" id="date" name="exp5" value= "<?php echo $d['exp5'];?>"> 
          </div>
