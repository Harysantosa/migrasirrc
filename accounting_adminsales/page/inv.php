...
?>
	...
	case 'add':
		if (isset($_POST['add'])) {
			...
			$query .= mysql_query("INSERT INTO piutang VALUES ('','$_POST[tgl]','$_POST[nm_cust]','$_POST[piutang]','$_POST[no_inv]','$_POST[tempo]','$_POST[tgl]','$_POST[nominal]','$_POST[metode_bayar]')");
			$query .= mysql_query("INSERT INTO rekap VALUES ('','$_POST[no_inv]','$_POST[do1]','$_POST[no_so]','$_POST[nm_cust]','$_POST[tgl]','$_POST[tempo]','$_POST[mobil]','$_POST[supir]','$_POST[nm_fg1]','$_POST[qty1]','$_POST[nm_fg2]','$_POST[qty2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[retur1]')");
			if ($query) {
...
";
										...
										<div class="form-group">
											<label for="exampleInputCustomer">Nama Customer</label>
											<input type="text" class="form-control" id="nm_cust" name="nm_cust" placeholder="Nama Customer" required data-fv-notempty-message="Tidak boleh kosong" readonly>
										</div>

										<div class="form-group">
											<label for="exampleInputCustomer">Nama Supir</label>
											<input type="text" class="form-control" id="supir" name="supir" placeholder="Nama Supir" required data-fv-notempty-message="Tidak boleh kosong" readonly>
										</div>

										<div class="form-group">
											<label for="exampleInputCustomer">Mobil</label>
											<input type="text" class="form-control" id="mobil" name="mobil" placeholder="Mobil" required data-fv-notempty-message="Tidak boleh kosong" readonly>
										</div>
