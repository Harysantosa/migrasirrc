...
<section class="content">
    ...
    <div class="box-header">
       <a href="cetak_laporanpiutang.php" target="_blank"> <button type="button" class="btn btn-info" ><i class="fa fa-print" target=_blank>Print Data Piutang Berdasarkan Tanggal</i></button>
       <a href="cetak_laporanpiutangcust.php" target="_blank"> <button type="button" class="btn btn-info" ><i class="fa fa-print" target=_blank>Print Data Piutang Berdasarkan Nama Customer</i></button> 
		</a>
			...
			<h2 align="left">Saldo Bank BCA <?php echo "Rp. ". number_format("$d[saldo]",'0','.','.')?></h2>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
				    include("indo.php");
                    $tampil=mysql_query("SELECT *,DATE_ADD(tgl,interval tempo DAY) as jatuh_tempo FROM piutang group by id order by id desc");
                    $no = 1;
