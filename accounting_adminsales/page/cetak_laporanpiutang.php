               ...
               <title>Print Laporan Produksi</title>
                ...
                <div class="form-group">
                    <td>
                     ...
                     <select class="form-control select2" id="nama" name="nama" style="width: 100%;" s>
                      <option value="" >--- Silahkan Pilih ---</option>
                   <?php
                $query = mysql_query("SELECT * FROM  customer order by nama asc");
                ...
                ?>
                    ...
                    <td colspan="2" width="190"><input type="submit" value="Pencarian Data" name="pencariancust"/></td>
