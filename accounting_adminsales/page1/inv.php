...
";    
			...
			?>
                    ...
                    <label for="exampleInputEmail1">No Rekening</label> 
					 ...
					 <input type="tex" class="form-control" id="retur1" name="retur1" onKeyUp="sum();" placeholder="masukan jumlah sak retur" >
					 <input type="text" class="form-control" id="fix1" name="fix1" onKeyUp="sum();" placeholder="jumlah setelah retur">
					...
					<div class="form-group">Produk2
					 ...
					 <input type="text" class="form-control" id="retur2" name="retur2" onKeyUp="sum();" placeholder="masukan jumlah sak retur" >	
					 <input type="text" class="form-control" id="fix2" name="fix2" onKeyUp="sum();">
					...
					<input type="text" class="form-control" id="retur3" name="retur3" onKeyUp="sum();" placeholder="masukan jumlah sak retur" >
					 <input type="text" class="form-control" id="fix3" name="fix3" onKeyUp="sum();">
					...
					<input type="text" class="form-control" id="retur4" name="retur4" onKeyUp="sum();" placeholder="masukan jumlah sak retur" >
					 <input type="text" class="form-control" id="fix4" name="fix4" onKeyUp="sum();">
					 <input type="text" class="form-control" id="harga4" name="harga4" onKeyUp="sum();" placeholder="masukan harga" >
