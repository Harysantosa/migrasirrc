...
<section class="content">
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
              $query = mysql_query("INSERT INTO salesorder VALUES ('','$_POST[no_so]','$_POST[so_ext]','$_POST[tgl]','$_POST[nm_cust]','$_POST[alamat]','$_POST[tlp]','$_POST[nm_fg1]','$_POST[qty1]','$_POST[status1]','$_POST[nm_fg2]','$_POST[qty2]','$_POST[status2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[status3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[status4]')");
...
";    
	...
	function changeValue(no_form){ 
	  ...
	  mysql_query("UPDATE salesorder SET no_so='$_POST[no_so]', so_ext='$_POST[so_ext]',tgl='$_POST[tgl]',nm_cust='$_POST[nm_cust]',alamat='$_POST[alamat]',pic='$_POST[pic]',nm_fg1='$_POST[nm_fg1]',qty1='$_POST[qty1]',nm_fg2='$_POST[nm_fg2]',qty2='$_POST[qty2]',nm_fg3='$_POST[nm_fg3]',qty3='$_POST[qty3]',nm_fg4='$_POST[nm_fg4]',qty4='$_POST[qty4]' WHERE id='$_POST[id]'");
