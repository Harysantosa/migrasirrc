      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <li class="header">Approval from QA</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i>
                <span>Checking</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
        
                <li><a href="?pg=rmin&act=view"><i class="fa fa-check-square-o"></i>RM Checking</a>
                 <li><a href="?pg=ppic&act=view"><i class="fa fa-check-square-o"></i>FG Checking</a></li>
