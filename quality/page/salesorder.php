  ...
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
        ...
        ,'$_POST[undeliv2]','$_POST[sisa2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[undeliv3]','$_POST[sisa3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[undeliv4]','$_POST[sisa4]')");
       ...
       $query .= mysql_query("INSERT INTO so VALUES ('','$_POST[do1]','$_POST[time]','$_POST[no_so]','$_POST[so_ext]','$_POST[segel]','$_POST[nm_cust]'
        ...
        ,'$_POST[exp2]','$_POST[nm_fg3]','$_POST[qty3]','$_POST[exp3]','$_POST[nm_fg4]','$_POST[qty4]','$_POST[exp4]')");
...
<body>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="h_fg" id="h_fg">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="h_price" id="h_price">
    ...
    <script>
        ...
        $("#h_fg").change(function(){
            // variabel dari nilai combo box merk
            var id_prod = $("#h_fg").val();
