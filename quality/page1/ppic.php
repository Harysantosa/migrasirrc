              ...
              <div class="box box-info">
                  ...
                  <table width="995" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    ...
                    ?>
						...
						<td><a href="?pg=ppic&act=add2&ppic_id=<?php echo $r['ppic_id']?>"><button type="button" class="btn bg-orange"><i class="fa fa-circle-o"></i></button></a></td>
...
<!-- /.box --><!-- /.col --><!-- /.row -->
 ...
 <?php
      ...
      // PROSES TAMBAH DATA PRODUK //
      case 'add2':
	  $d = mysql_fetch_array(mysql_query("SELECT * FROM ppic_plan WHERE ppic_id='$_GET[ppic_id]'"));
      if (isset($_POST['add2'])) {
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					      ...
					      <div class="form-group">NO Planing ADDED
                    <input readonly  class="form-control" id="ppic_id" name="ppic_id" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['ppic_id'];?>" >
					</div>	
  ...
  <?php
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM ppic_plan WHERE id='$_GET[id]'"));
            if (isset($_POST['update'])) {
				...
				mysql_query("UPDATE ppic_plan SET ppic_id='$_POST[ppic_id]', nm_fg='$_POST[nm_fg]', tgl='$_POST[tgl]',shift='$_POST[shift]',batch1='$_POST[batch1]', r1='$_POST[r1]', rm1='$_POST[rm1]',r2='$_POST[r2]', rm2='$_POST[rm2]', r3='$_POST[r3]', rm3='$_POST[rm3]', r4='$_POST[r4]', rm4='$_POST[rm4]', r5='$_POST[r5]', rm5='$_POST[rm5]', r6='$_POST[r6]', rm6='$_POST[rm6]', r7='$_POST[r7]', rm7='$_POST[rm7]', r8='$_POST[r8]', rm8='$_POST[rm8]', r9='$_POST[r9]', rm9='$_POST[rm9]', r10='$_POST[r10]', rm10='$_POST[rm10]', r11='$_POST[r11]', rm11='$_POST[rm11]', r12='$_POST[r12]', rm12='$_POST[rm12]', r13='$_POST[r13]', rm13='$_POST[rm13]',r14='$_POST[r14]', rm14='$_POST[rm14]',r15='$_POST[r15]', rm15='$_POST[rm15]',r16='$_POST[r16]', rm16='$_POST[rm16]',r17='$_POST[r17]', rm17='$_POST[rm17]',r18='$_POST[r18]', rm18='$_POST[rm18]' WHERE id='$_POST[id]'");
