...
<section class="content">
    ...
    <a href="?pg=rm&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data</i></button> </a>
    </div><!-- /.box-header -->
              <!-- general form elements -->
              <div class="box box-info">
                  <div class="box-body">
                  <div class="table-responsive">
                  <table width="432" height="73" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr>
						 <th width="24">NO</th>
                        <th width="125">Nama Bahan Baku</th>
						 <th width="112">Edit</th>
						  <th width="151">Hapus</th>
                      </tr>
                    </thead>
                    ...
                    ?>
						...
						<td><a href="?pg=rm&act=edit&id=<?php echo $r['id_rm']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td><a href="?pg=rm&act=delete&id=<?php echo $r['id_rm']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
                        </tr>
						<?php
                    $no++;
                    }
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">		  
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" class="form-control" id="nama_rm"  name="nama_rm" placeholder="Nomor Bahan Baku" required data-fv-notempty-message="Tidak boleh kosong" style="text-transform:uppercase">
                    </div>
