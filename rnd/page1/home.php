...
<html>
  <head>
    ...
    <title> RND // SIP| PT Raja Roti Cemerlang</title>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
		  ...
		  <li class="header">Master Data RnD</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i>
                <span>Manajemen RnD</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?pg=formula&act=view"><i class="fa fa-check-square-o"></i>Formula Breadcrumb</a></li>
				<li><a href="?pg=premix&act=view"><i class="fa fa-check-square-o"></i>Formula Premix</a></li>
				<li><a href="?pg=stokfg&act=view"><i class="fa fa-check-square-o"></i>Data Barang</a></li>
				</li>
