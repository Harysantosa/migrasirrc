	...
	?>
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          <?php $liatHarga=mysql_fetch_array(mysql_query("SELECT total1,total2,total3,total4 ,(total1+total2+total3+total4) as total_hrg FROM inv where id ='$_GET[id]'"));?>
                          <td bgcolor="#1E9BEB" align = "center">Rp.<?php echo "". number_format("$liatHarga[total_hrg]")?> </td>
						
                        </tr>
                        <tr>
                          <td align = "left" bordercolor="#F81115" colspan="3">PPN</td>
						   <?php $liatHarga=mysql_fetch_array(mysql_query("SELECT total1,total2,total3,total4 ,((total1+total2+total3+total4)*0.1) as total_ppn FROM inv where id ='$_GET[id]'"));?>
                          <td bgcolor="#1E9BEB" align = "center">Rp.<?php echo "". number_format("$liatHarga[total_ppn]")?></td>
                        </tr>
                        <tr>
                          <td align = "left" bordercolor="#F81115" colspan="3">JUMLAH YANG DIBAYAR</td>
						 <?php $liatHarga=mysql_fetch_array(mysql_query("SELECT total1,total2,total3,total4 ,((total1+total2+total3+total4)*0.1+(total1+total2+total3+total4)) as subtotal FROM inv where id ='$_GET[id]'"));?>
                          <td bgcolor="#1E9BEB" align = "center">Rp.<?php echo "". number_format("$liatHarga[subtotal]")?></td>
                        </tr>
