...
<section class="content">
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysql_query("INSERT INTO formula_new VALUES ('','$_POST[id_fg]',
                '$_POST[no_form]','$_POST[tgl]','$_POST[nm_fg]','$_POST[terigu1]','$_POST[terigu2]',
                '$_POST[r1]','$_POST[rm1]','$_POST[r2]','$_POST[rm2]','$_POST[r3]','$_POST[rm3]','$_POST[r4]',
                '$_POST[rm4]','$_POST[r5]','$_POST[rm5]','$_POST[r6]','$_POST[rm6]','$_POST[r7]','$_POST[rm7]',
                '$_POST[r8]','$_POST[rm8]','$_POST[r9]','$_POST[rm9]','$_POST[r10]','$_POST[rm10]','$_POST[r11]',
                '$_POST[rm11]','$_POST[r12]','$_POST[rm12]','$_POST[r13]','$_POST[rm13]','$_POST[r14]','$_POST[rm14]',
                '$_POST[r15]','$_POST[rm15]','$_POST[r16]','$_POST[rm16]','$_POST[r17]','$_POST[rm17]')");
		  
		        $query .= mysql_query("INSERT INTO stok_fg VALUE('','$_POST[no_form]',(UPPER('$_POST[nm_fg]')),'$_POST[stok]')");
...
echo $tgl;?> ">
                     ...
                     <div class="form-group">
                      <input readonly class="form-control" id="ter1" name="ter1" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="Terigu Standart" >
					  <input "text" class="form-control" id="terigu1" name="terigu1" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
                  </div>
				  
				  <div class="form-group">
                      <input readonly class="form-control" id="r1" name="r1" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="Terigu Premium" >
					  <input "text" class="form-control" id="terigu2" name="terigu2" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
                  </div>
                  ...
                  <div class="form-group">
					  ...
					  <input "text" class="form-control" id="rm14" name="rm14" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
					     ...
					     <div class="form-group">
                      <input readonly class="form-control" id="r15" name="r15" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="SHORTENING" >
					  <input "text" class="form-control" id="rm15" name="rm15" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
                  </div>
					  
					   <div class="form-group">
                      <input readonly class="form-control" id="r16" name="r16" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="MARGARINE" >
					  <input "text" class="form-control" id="rm16" name="rm16" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
                  </div>
					
					 <div class="form-group">
                      <input readonly class="form-control" id="r17" name="r17" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="PRX 09" >
					  <input "text" class="form-control" id="rm17" name="rm17" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" >
                  </div>
    ...
    <!-- /.row (main row) -->
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM formula_new where no='$_GET[no]'"));
            if (isset($_POST['update'])) {	
                ...
                mysql_query("UPDATE formula_new SET no_form='$_POST[no_form]',nm_fg='$_POST[nm_fg]',tgl='$_POST[tgl]',terigu1='$_POST[terigu1]',terigu2='$_POST[terigu2]',r1='$_POST[r1]',rm1='$_POST[rm1]',r2='$_POST[r2]',rm2='$_POST[rm2]',r3='$_POST[r3]',rm3='$_POST[rm3]',r4='$_POST[r4]',rm4='$_POST[rm4]',r5='$_POST[r5]',rm5='$_POST[rm5]',r6='$_POST[r6]',rm6='$_POST[rm6]',r7='$_POST[r7]',rm7='$_POST[rm7]',r8='$_POST[r8]',rm8='$_POST[rm8]',r9='$_POST[r9]',rm9='$_POST[rm9]',r10='$_POST[r10]',rm10='$_POST[rm10]',r11='$_POST[r11]',rm11='$_POST[rm11]',r12='$_POST[r12]',rm12='$_POST[rm12]',r13='$_POST[r13]',rm13='$_POST[rm13]',r14='$_POST[r14]',rm14='$_POST[rm14]',r15='$_POST[r15]',rm15='$_POST[rm15]',r16='$_POST[r16]',rm16='$_POST[rm16]',r17='$_POST[r17]',rm17='$_POST[rm17]' WHERE no='$_POST[no]'");
...
echo $tgl;?> ">
                    ...
                    <div class="form-group">
                    <label for="exampleInputEmail1">Terigu 1 </label>
					      <input "text" class="form-control"  id="terigu1" name="terigu1" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="<?php echo $d['terigu1'];?>" >
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Terigu 2 </label>
					      <input "text" class="form-control"  id="terigu2" name="terigu2" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="<?php echo $d['terigu2'];?>" >
                  </div>
					  
			      <div class="form-group">
                      <input readonly class="form-control" id="r1" name="r1" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="PRX A" >
                  ...
                  <div class="form-group">
                      <input readonly class="form-control" id="r15" name="r15" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="SHORTENING" >
					  <input "text" class="form-control" id="rm15" name="rm15" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="<?php echo $d['rm15'];?>" >
                  </div>  
					  
					   <div class="form-group">
                      <input readonly class="form-control" id="r16" name="r16" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="MARGARINE" >
					  <input "text" class="form-control" id="rm16" name="rm16" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="<?php echo $d['rm16'];?>" >
                  </div>  
						 <div class="form-group">
                      <input readonly class="form-control" id="r17" name="r17" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" 
					  value="PRX 09" >
					  <input "text" class="form-control" id="rm17" name="rm17" style="text-transform:uppercase" required data-fv-notempty-message="Tidak boleh kosong" value="<?php echo $d['rm17'];?>" >
                  </div>
