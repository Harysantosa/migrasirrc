...
<table width="75%" border="0">
  <tr> 
    <td align="center"><h1><em><strong>Cetak Stok Keluar</strong></em></h1></td>
  </tr>
  <tr> 
...
<table width="1100" border="0">
  <tbody>
    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM rekapcutrm where id='$_GET[id]'");
            	 $no = 1;
			       $r=mysql_fetch_array($tampil);{
                    ...
                    ?>
    <tr> 
      <td width="248" height="28">No PLANROD</td>
      <td width="183">: <?php echo "$r[plan_prod]"?></td>
    ...
    <tr> 
      ...
      <td colspan="2"><div align="center"><strong><u>Kepala Produksi</u></strong></div></td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
</table>
...
<table width="84%" border="0">
  <tr> 
    <td width="14%" height="50" background="" bgcolor="#FF0000" > <h3 align="center"><font face="Courier New, Courier, mono"><u>PREMIX 
        ANGKA</u></font></h3></td>
    <td width="18%" bgcolor="#FF0000"background="" > <h3 align="center"><font face="Courier New, Courier, mono"><u>JUMLAH 
        (KG)</u></font></h3></td>
    <td width="1%" rowspan="6"  >&nbsp;</td>
    <td width="17%" bgcolor="#FF0000"background="" ><h3 align="center"><font face="Courier New, Courier, mono"><u><strong>PREMIX 
        ALFABET</strong></u></font></h3></td>
    <td width="14%" bgcolor="#FF0000"background="" ><h3 align="center"><font face="Courier New, Courier, mono"><u><strong>JUMLAH 
        (KG)</strong></u></font></h3></td>
    <td width="1%" > <h3 align="center"><font face="Courier New, Courier, mono"><u></u></font></h3></td>
    <td width="19%" background="" bgcolor="#FF0000"><h3 align="center"><font face="Courier New, Courier, mono"><u><strong>RAW 
        MATERIAL </strong></u></font></h3></td>
    <td width="16%" background="" bgcolor="#FF0000"><h3 align="center"><font face="Courier New, Courier, mono"><u><strong>JUMLAH 
        (KG)</strong></u></font></h3></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td>&nbsp;</td>
    <td><div align="center">label <?php echo   "$r[r16]"?> </td>
    <td><?php echo   "$r[rm16]"?> pcs</td>
  </tr>
</table>
