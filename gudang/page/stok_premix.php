...
<section class="content">
    ...
    <a href=""> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data Premix</i></button> </a>
    </div><!-- /.box-header -->
                  ...
                  <table width="788"  class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
                        ...
                        <th width="402" style="text-align: left">ID Premix </th>
                    ...
                    <tbody>
                    <?php
                    $tampil=mysql_query("SELECT * FROM stok_fgpremix order by id asc");
                    $no1 = 1;
