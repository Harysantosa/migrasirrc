...
<table width="75%" border="0">
  <tr> 
    <td align="center"><h1><em><strong>Cetak Cut Stok Produksi Premix </strong></em></h1></td>
  </tr>
  <tr> 
...
<table width="1100" border="0">
  <tbody>
    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM premixcut where no='$_GET[no]'");
            	 $no = 1;
...
<h3 align="center"><font face="Courier New, Courier, mono">Nama 
  ...
  <tr> 
    <td height="41"><div align="center"><?php echo "$r[r1]"?></div></td>
    <td><?php echo "$r[jml1]"?></td>
    <td height="41"><div align="center"><?php echo "$r[r6]"?></div></td>
    <td><?php echo "$r[jml6]"?></td>
  </tr>
  <tr> 
    <td height="40"><div align="center"><?php echo "$r[r2]"?></div></td>
    <td><?php echo "$r[jml2]"?></td>
    <td height="40"><div align="center"><?php echo "$r[r7]"?></div></td>
    <td><?php echo "$r[jml7]"?></td>
  </tr>
  <tr> 
    <td height="40"><div align="center"><?php echo "$r[r3]"?></div></td>
    <td><?php echo "$r[jml3]"?></td>
    <td height="40"><div align="center"><?php echo "$r[r8]"?></div></td>
    <td><?php echo "$r[jml8]"?></td>
  </tr>
  <tr> 
    <td height="37"><div align="center"><?php echo "$r[r4]"?></div></td>
    <td><?php echo "$r[jml4]"?></td>
    <td height="37"><div align="center"><?php echo "$r[r9]"?></div></td>
    <td><?php echo "$r[jml9]"?></td>
  </tr>
  <tr> 
    <td height="37"><div align="center"><?php echo "$r[r5]"?></div></td>
    <td><?php echo "$r[jml5]"?></td>
    <td height="37"><div align="center"><?php echo "$r[r10]"?></div></td>
