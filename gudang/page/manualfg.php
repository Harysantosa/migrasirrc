...
<div class="content-wrapper">
        ...
        <h1>Data Verifikasi Finish Good Manual</h1>
            <ol class="breadcrumb">
              ...
              <div class="box box-info">
                  ...
                  <table width="966" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    ...
                    ?>
                       ...
                       <td><a href="?pg=manualfg&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-primary" onclick="return confirm('apakah anda yakin ingin mengembalikan stok FG?');"><i class = "fa fa-trash-o"></i></button></a></td>
                        </tr>
					  </tr>
						<?php
                    $no++;
    ...
    <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                ?>
					...
					<div class="form-group">Tanggal Barang Masuk
