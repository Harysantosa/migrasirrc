 ...
 <?php
	  ...
	  $d = mysql_fetch_array(mysql_query("SELECT * FROM gudangrm WHERE id='$_GET[id]'"));
		 ...
		 &&$_POST['sisa13']>= '0'&&$_POST['sisa14']>= '0'&&$_POST['sisa15']>= '0'&&$_POST['sisa16']>= '0' &&$_POST['sisa17']>= '0'){
			...
			mysql_query("INSERT INTO rakapcutrm VALUES ('','$_POST[plan_prod]','$_POST[no_form]'
			,'$_POST[nm_fg]','$_POST[tgl]','$_POST[shift]','$_POST[leader]','$_POST[lot]','$_POST[screen]'
			,'$_POST[terigua]','$_POST[jmlt1]','$_POST[terigub]','$_POST[jmlt2]','$_POST[r1]','$_POST[jml1]'
			,'$_POST[r2]','$_POST[jml2]','$_POST[r3]','$_POST[jml3]','$_POST[r4]','$_POST[jml4]','$_POST[r5]'
			,'$_POST[jml5]','$_POST[r6]','$_POST[jml6]','$_POST[r7]','$_POST[jml7]','$_POST[r8]','$_POST[jml8]'
			,'$_POST[r9]','$_POST[jml9]','$_POST[r10]','$_POST[jml10]','$_POST[r11]','$_POST[jml11]','$_POST[r12]'
			,'$_POST[jml12]','$_POST[r13]','$_POST[jml13]','$_POST[r14]','$_POST[jml14]','$_POST[r15]','$_POST[jml15]'
			,'$_POST[r16]','$_POST[jml16]','$_POST[r17]','$_POST[jml17]','$_POST[r18]','$_POST[rm18]','$_POST[r19]'
			,'$_POST[rm19]','$_POST[r20]','$_POST[rm20]','$_POST[status]','$_POST[ket]')");
		  
		  mysql_query("UPDATE gudangrm SET ket ='$_POST [ket]' WHERE id='$_POST[id]'");
	  
	   
	   
			
		  		// mysql_query("DELETE FROM gudangrm WHERE id='$_GET[id]'");
		        echo "<script> alert('data berhasil disimpan dan stok terpotong !');window.location='home.php?pg=rekapcutrm&act=view'</script>";
              }else {
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<div class="form-group"> kode produk
				   ...
				   <div class="form-group">
					...
					<input readonly class="form-control" id="r12" name="r12" value="<?php echo $d['r12'];?>">
					 <?php
					   ...
					   ?>
					  <input readonly class="form-control"  id="prx7" name="prx7" value="<?php echo $a['stok'];?>" onKeyUp="sum();" >
					...
					<input readonly class="form-control" id="r13" name="r13" value="<?php echo $d['r13'];?>">
					 <?php
					   ...
					   ?>
					  <input readonly class="form-control"    id="prx8" name="prx8" value="<?php echo $a['stok'];?>" onKeyUp="sum();" >
					...
					<?php
					   $a = mysql_fetch_array(mysql_query("SELECT * FROM stok_fgpremix WHERE id='15'"));
					   ?>
					  <input readonly class="form-control"   id="short" name="short" value="<?php echo $a['stok'];?>" onKeyUp="sum();" >
                    <input readonly class="form-control" id="jml15" name="jml15" value="<?php echo $d['jml15'];?>" onKeyUp="sum();" >
					 
					  <input readonly class="form-control"   id="sisa15" name="sisa15" onKeyUp="sum();" placeholder="klik untuk kolom dijumlah" required data-fv-notempty-message="Tidak boleh kosong">
					  </div>
					...
					<?php
					   $a = mysql_fetch_array(mysql_query("SELECT * FROM stok_fgpremix WHERE id='16'"));
					   ?>
					  <input readonly class="form-control"   id="marga" name="marga" value="<?php echo $a['stok'];?>" onKeyUp="sum();" >
                    <input readonly class="form-control" id="jml16" name="jml16" value="<?php echo $d['jml16'];?>" onKeyUp="sum();" >
					...
					<div class="form-group">
					 ...
					 <?php
					   $a = mysql_fetch_array(mysql_query("SELECT * FROM stok_fgpremix WHERE id='17'"));
					   ?>
					  <input readonly class="form-control"   id="prx09" name="prx09" value="<?php echo $a['stok'];?>" onKeyUp="sum();">
                    <input readonly class="form-control" id="jml17" name="jml17" value="<?php echo $d['jml17'];?>" onKeyUp="sum();">
					...
					<div class="form-group">
					<input readonly class="form-control" id="r19" name="r19" value="<?php echo $d['r19'];?>">
                    <input readonly class="form-control" id="rm19" name="rm19" value="<?php echo $d['rm18'];?>">
					</div>

					<div class="form-group">
					<input readonly class="form-control" id="r20" name="r20" value="<?php echo $d['r20'];?>">
                    <input readonly class="form-control" id="rm20" name="rm20" value="<?php echo $d['rm20'];?>">
					</div>
					  
					  
					 <div class="form-group"> Status Proses
					<input type readonly class="form-control" id="status" name="status" value="Berhasil Dipotong">
					<input type="hidden" class="form-control" id="ket" name="ket" value="1">
                    </div>	
		...
		document.getElementById('stok3').value = frm1[label].stok;
				...
				<script>
						...
						function sum() {
							...
							var txt40= document.getElementById('prx7').value;
							var txt41 = document.getElementById('jml12').value;
							var txt42 = document.getElementById('sisa12').value;

							var txt43= document.getElementById('prx8').value;
							var txt44 = document.getElementById('jml13').value;
							var txt45 = document.getElementById('sisa13').value;

							var txt46= document.getElementById('ragi').value;
							var txt47 = document.getElementById('jml14').value;
							var txt48 = document.getElementById('sisa14').value;
																	
							var txt49= document.getElementById('short').value;
							var txt50 = document.getElementById('jml15').value;
							var txt51 = document.getElementById('sisa15').value;
							
							var txt52= document.getElementById('marga').value;
							var txt53 = document.getElementById('jml16').value;
							var txt54 = document.getElementById('sisa16').value;
												
							var txt55= document.getElementById('prx09').value;
							var txt56 = document.getElementById('jml17').value;
							var txt57 = document.getElementById('sisa17').value;
							...
							var result17= (txt49)-(txt50);
      						if (!isNaN(result17)) {
         					document.getElementById('sisa15').value = result17;
							}
							
							var result18= (txt52)-(txt53);
      						if (!isNaN(result18)) {
         					document.getElementById('sisa16').value = result18;
							}
							
							var result19= (txt55)-(txt56);
      						if (!isNaN(result19)) {
         					document.getElementById('sisa17').value = result19;
							}
