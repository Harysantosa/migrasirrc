	...
	?>
               ...
               <title>Print Laporan Produksi</title>
                    <table width="1007" border="0">
                      <tbody>
                        <tr>
                         <td width="457" height="38" colspan="3" valign="top"><h1 style="text-align: left">LAPORAN PENGGUNAAN BAHAN BAKU PREMIX</h1></td>
                    ...
                    <form action="cetak_cutrmpremix.php" method="post" name="postform">
                      <table border="0">
                <tr>
        ...
        <?php
          ...
          <script language="JavaScript">
                ...
                document.location='centak_cutrmpremix.php';
            </script>
            <?php
            }else{
        ...
        <table width="1265" height="82" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr bgcolor="#FF6600">
                ...
                <th width="29" style="text-align: center">No</th>
					...
					<th width="63" style="text-align: center">Jumlah Lot</th>
                        <th width="57" style="text-align: center">Nama Produk</th>
				<th width="57" style="text-align: center">Nama Bahan Baku</th>
				<th width="57" style="text-align: center">Jumlah</th>
				...
				<th width="57" style="text-align: center">Jumlah</th>
                        ...
                        <th width="46" style="text-align: center">Jumlah Produksi Masuk</th>
            ...
            <tr>
				...
				<td align="left" style="text-align: center"><?php echo "$r[lot]"?></td>
				 ...
				 <td style="text-align: center"><?php echo "$r[r1]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm1]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r2]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm2]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r3]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm3]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r4]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm4]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r5]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm5]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r6]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm6]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r7]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm7]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r8]"?></td>
				 <td style="text-align: center"><?php echo "$r[rm8]"?></td> 
				
				<td style="text-align: center"><?php echo "$r[r9]"?></td>
