...
<div class="content-wrapper">
        ...
        <h1>Detail Stok Finish Good</h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active">Data Detai Stok Finish good</ol>
        </section>
...
<section class="content">
              ...
              <div class="box box-info">
                  ...
                  <table width="966" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
                        <th width="83">No</th>
                        <th width="248">Nama Finish Good</th>
                        <th width="198">Expired Date</th>
						<           <th width="242">Detail FG </th>
                    ...
                    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM stok_fg WHERE nm_fg='$_GET[nm_fg]'"));
                    $no = 1;
                    ...
                    ?>
						...
						<td><?php echo TanggalIndo($r['stok'])?></td>
                       
              <td><a href="?pg=detailfg&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-primary" onclick="return confirm('apakah anda yakin ingin mengembalikan stok FG?');"><i class = "fa fa-trash-o"></i></button></a></td>
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
                ...
                $query = mysql_query("INSERT INTO gudang_fg VALUES ('','$_POST[no_lap]','$_POST[tgl]','$_POST[shift]','$_POST[nm_fg]','$_POST[tgl_drying]','$_POST[fg]','$_POST[fg1]','$_POST[exp]')");
		  		 		
                echo "<script>window.location='home.php?pg=detailfg&act=view'</script>";
              }
              ?>
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<option value=''>--- Pilih Lap Produksi ---</option>
					<?php 
					$result = mysql_query("select * from lapprod ");    
...
plan_prod:'" . addslashes($row['plan_prod']) . "',
...
";    
					...
					?>    
					 ...
					 <div class="form-group">
                      ...
                      <input readonly class="form-control" id="plan_prod" name="plan_prod"  placeholder="NO Planing" type="text" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
                    ...
                    <input readonly class="form-control" id="tgl_drying" name="tgl_drying" required data-fv-notempty-message="Tidak boleh kosong" />
					</div>	
					
					   <div class="form-group">Data FG Produksi
					  <input readonly class="form-control" id="fg" name="fg" required data-fv-notempty-message="Tidak boleh kosong" />
                      </div>
					  	
					 <div class="form-group">Data FG Gudang
					  <input type="text" class="form-control" id="fg1" name="fg1" required data-fv-notempty-message="Tidak boleh kosong" />
                      </div>

                      <div class="form-group">Expierd produk
					  <input type="date" class="form-control" id="exp" name="exp" required data-fv-notempty-message="Tidak boleh kosong" />
                      </div>
	...
	function changeValue(no_form){ 
		document.getElementById('plan_prod').value = frm[no_form].plan_prod;
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysql_query("DELETE FROM gudang_fg WHERE id='$_GET[id]'");
      echo "<script>window.location='home.php?pg=detailfg&act=view'</script>";
      break;
