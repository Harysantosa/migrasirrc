...
if (!isset($_GET['pg'])) {
	...
	switch ($_GET['pg']) {
		case 'ppicform':
			...
			break;
			case 'premixin':
			include 'premixin.php';
			break;
			case 'premixcut':
			include 'verifikasipremixcut.php';
			break;
		case 'ppic':
			include 'ppic.php';
			break;
			case 'rekapcutrm':
			include 'rekapcutrm.php';
			break;
			case 'verfwip':
		...
		case 'hutang':
			...
			break;
			case 'stoklabel':
			include 'stok_label.php';
			break;
			case 'stokpremix':
			include 'stok_premix.php';
			break;		
