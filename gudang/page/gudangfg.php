...
<section class="content">
	   ...
	   <a href="cetak_lapfg.php"> <button type="button" class="btn btn-info"><i class = "fa fa-print"> Cetak Laporan Barang Masuk</i></button> </a>
                  ...
                  <table width="966" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
						...
						<th width="242">Roll Back Stok fg </th>
            <th width="242">Detail FG </th>
                    ...
                    ?>
						...
						<td><?php echo "$r[shift_drying]"?></td>
					     <td align="center"><?php echo "$r[fg1]"?></td>
							<td><a href="?pg=gudangfg&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-primary" onclick="return confirm('apakah anda yakin ingin mengembalikan stok FG?');"><i class = "fa fa-trash-o"></i></button></a></td>
              <td style="text-align: center"><a href="?pg=detailfg&act=view&nm_fg=<?php echo $r['nm_fg']?>">
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
                ...
                $query = mysql_query("INSERT INTO gudang_fg VALUES ('','$_POST[plan_prod]','$_POST[tgl]','$_POST[shift_drying]','$_POST[nm_fg]','$_POST[tgl_drying]','$_POST[fg]','$_POST[fg1]','$_POST[exp]')");
