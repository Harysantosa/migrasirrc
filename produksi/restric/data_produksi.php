...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
      if  ($_POST['sisa']>='0'){ 
                $query = mysql_query("INSERT INTO lapprod VALUES ('','$_POST[no_lap]','$_POST[plan_prod]','$_POST[tgl]','$_POST[mixer]'
        ,'$_POST[oven]','$_POST[dd]','$_POST[shift]','$_POST[nm_fg]','$_POST[lot]','$_POST[aktualroti]','$_POST[sisa]','$_POST[jumlah]','$_POST[fg]','$_POST[prosentase]','$_POST[tgl_drying]','$_POST[shift_drying]','$_POST[berita]')");
          ...
          $query .= mysql_query("INSERT INTO sisaracikan VALUES ('','$_POST[no_lap]','$_POST[plan_prod]','$_POST[tgl]','$_POST[shift]','$_POST[nm_fg]','$_POST[lot]','$_POST[aktualroti]','$_POST[sisa]','$_POST[jumlah]','$_POST[keterangan]')");
           ...
           $query .= mysql_query("INSERT INTO lapdry VALUES ('','$_POST[no_lap]','$_POST[plan_prod]','$_POST[tgl]','$_POST[shift]','$_POST[nm_fg]','$_POST[jumlah]','$_POST[fg]','$_POST[prosentase]','$_POST[tgl_drying]','$_POST[shift_drying]','$_POST[berita]')");
...
";    
 ...
 <div class="form-group">
                      <label for="exampleInputEmail1">Pilih Mixer</label> <br>
                      <select class="form-control select2" name="mixer" id="mixer" style="width: 100%;" required data-fv-notempty-message="Tidak boleh kosong" >
                        <option value="">--Silahkan Pilih--</option>
                        <option value="Mixer35">Mixer 35</option>
                        <option value="Mixer50">Mixer 50</option>
          ...
          <div class="form-group">
                      <label for="exampleInputEmail1">Pilih Oven</label> <br>
                      <select class="form-control select2" name="oven" id="oven" style="width: 100%;" required data-fv-notempty-message="Tidak boleh kosong" >
                        <option value="">--Silahkan Pilih--</option>
                        <option value="OB Bake">Oven Bake</option>
                        
                        <option value="EB_lama">Elektro Bake Lama</option>
                        <option value="EB_baru">Elektro Bake Baru</option>
                         </select>
          </div>
            
          <div class="form-group">
                      <label for="exampleInputEmail1">Pilih Drum dryer</label> <br>
                      <select class="form-control select2" name="dd" id="dd" style="width: 100%;" required data-fv-notempty-message="Tidak boleh kosong" >
                        <option value="">--Silahkan Pilih--</option>
                        <option value="DD1">Drum Dryer 1</option>
                        <option value="DD2">Drum Dryer 2</option>
						  <option value="DD3">Drum Dryer 3</option>
                        <option value="DD4">Drum Dryer 4</option>
                        </select>
          </div>
