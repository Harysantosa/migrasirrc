                  ...
                  <table width="995" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
                        ...
                        <th width="97" style="text-align: center">Aktual Drying/th>
                    ...
                    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM sisadrying order by plan_prod");
            		 $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
	   if  ($_POST['sisa']>='0'){ 
		   ...
		   mysql_query("UPDATE sisadrying SET no_lap='$_POST[no_lap]',plan_prod='$_POST[plan_prod]', tgl='$_POST[tgl]', shift='$_POST[shift]', nm_fg='$_POST[nm_fg]', lot='$_POST[lot]', aktualroti='$_POST[aktualroti]', sisa='$_POST[sisa]', keterangan='$_POST[keterangan]' WHERE id='$_POST[id]'");
		   
          
           
		 echo "<script> alert('data berhasil disimpan dan stok terpotong !');window.location='home.php?pg=sisadrying&act=view'</script>";
		  }else {
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
				  ...
				  <div class="form-group">Tanggal Drying
				   ...
				   <div class="form-group">Sisa Drying (Zak)
                    ...
                    <input readonly  class="form-control" id="keterangan" name="keterangan"  placeholder="keterangan" value="Data Sisa Drying <?php echo $d['plan_prod'];?>" >
					</div>	
