    ...
    <div class="box-header">
              ...
              <div class="box box-info">
                  ...
                  <div class="table-responsive">
					  ...
					  <table width="445" height="73" class="table table-bordered table-striped" id="example style="width: 90%;">
					   <thead>
                        ...
                        <th width="80" style="text-align: center">Shift Drying</th>
                     	<th width="66" style="text-align: center">Ket</th>
						  ...
						  <tbody>
                                   <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM mixing order by id desc");
            		 $no = 1;
					...
					?>
                      ...
                      <tr>
                        ...
                        <td><a href="?pg=dataprod&act=delete&id=<?php echo $r['id']?>"><button  type="button" class="btn btn-danger" onClick="return confirm('Anda akan menghapus data planing PPIC <?php echo $r['id']?>');"><i class = "fa fa-trash-o"></i></button></i></button></a></td>
                      </tr>
						...
						?>
                                    <tr>
                                      <td align = "left" bordercolor="#F81115" colspan="7" col><span style="font-weight:bold">TOTAL</span></td>
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<option value=''>-Pilih Planing-</option>
					<?php 
					$result = mysql_query("select * from planprod group by id desc ");    
    ...
    <div class="col-md-12">
              ...
              <div class="box box-info">
				...
				<div class="form-group">
                      ...
                      <input type="text" class="form-control" id="shift" name="shift"  placeholder="MM/DD/YYY" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['shift'];?>" >
                    </div>
					  
					  <div class="form-group">
                      <label for="exampleInputEmail1">Target Produksi Roti</label>
                      <input type="text" class="form-control" id="batch1" name="batch1"  placeholder="MM/DD/YYY" type="text" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['batch1'];?>" onClick="sum();">
                    </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Shift Drying</label> 
                      <select class="form-control select2" name="shift_drying" style="width: 100%;" >
					   ...
					   <input readonly class="form-control" name="shift_drying"  placeholder="MM/DD/YYY" type="text" value= "<?php echo $d['shift_drying'];?>">
                      </div>
					  
					  	<div class="form-group">Keterangan
                    <input class="form-control" id="berita" name="berita"  placeholder="keterangan" type="text" value= "<?php echo $d['berita'];?>">
					</div>					  
