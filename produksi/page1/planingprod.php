    ...
    <div class="box-header">
              ...
              <div class="box box-info">
                  ...
                  <table width="995" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    ...
                    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM planprod GROUP by id desc");
                    $no = 1;
                    ...
                    ?>
						...
						<td><a href="?pg=planingprod&act=edit1&id=<?php echo $r['id']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil"></i></button></a></td>
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                 <div class="form-group">
					...
					<div class="form-group">Kanban Number
                    <input class="form-control" id="kanban" name="kanban"  type="text" required data-fv-notempty-message="Tidak boleh kosong" valu>
					</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">Masukan kategori screen                   
                      <input type="text" class="form-control" id="batch1" name="batch1" placeholder="Input Jumlah Batch" required data-fv-notempty-message="Tidak boleh kosong" onKeyUp="sum();"  >
                    </div>
                    ...
                    <input readonly class="form-control" id="rm9" name="rm9" >
					 ...
					 <div class="form-group"> Masukan Jenis Plastik-2
                      ...
                      <input "text" class="form-control" id="rm17" name="rm17"  >
					   ...
					   <div class="form-group">
						  <input readonly class="form-control" id="r18" name="r18"  value="plastik ke 2"> 
						 <input readonly class="form-control" id="rm18" name="rm18"  value="rm-19 pe kuning 49x79x60m">  
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<div class="form-group">Kanban Number
                    <input readonly class="form-control" id="kanban" name="kanban"  type="text" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['nm_fg'];?><?php  echo $d['tgl'];?><?php echo $d['kode1'];?>">
					</div>
					  
                  	 <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Produksi</label>
                      <input readonly class="form-control" id="date"  name="tgl" value= "<?php date("dmy", $d); echo $d['tgl'];?>" >
                    </div>
					  
					   <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Oven</label>
                      <input readonly class="form-control" id="jenis_oven" name="jenis_oven" value= "<?php echo $d['jenis_oven'];?>" >
                    </div>
					...
					<div class="form-group">
                      ...
                      <input readonly class="form-control" id="scren" name="screen" value= "<?php echo $d['screen'];?>" >
                    </div>
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                      <label for="exampleInputEmail1">Jumlah Limbah</label>
                      <input readonly class="form-control" id="limbah" name="limbah" value= "input limbah setelah melakukan verifikasi planing produksi" >
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<div class="form-group">Kanban Number
                    <input class="form-control" id="kanban" name="kanban"  type="text" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['nm_fg'];?><?php  echo $d['tgl'];?><?php echo $d['kode1'];?>">
					</div>
					  
                  	 <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Produksi</label>
                       <input type="text" class="form-control" id="date"  name="tgl" value= "<?php date("dmy", $d); echo $d['tgl'];?>" >
                    </div>
					  
					   <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Oven</label>
                       <input type="text" class="form-control" id="jenis_oven" name="jenis_oven" value= "<?php echo $d['jenis_oven'];?>" >
                    </div>
					  
                  	<div class="form-group">
                      <label for="exampleInputEmail1">Shift Produksi</label>
                      <input type="text" class="form-control" id="shift" name="shift" value= "<?php echo $d['shift'];?>" >
                    </div>
					...
					<div class="form-group">
                      <label for="exampleInputEmail1">Aktual Mixing(Batch)</label>
                       <input type readonly class="form-control" id="batch1" name="batch1" value= "<?php echo $d['batch1'];?>" >
                    </div>
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                      <label for="exampleInputEmail1">Jumlah Limbah</label>
                      <input type="text" class="form-control" id="limbah" name="limbah" value= "<?php echo $d['limbah'];?>" >
