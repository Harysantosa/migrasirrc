                  ...
                  <table width="445" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%">
                    <thead>
                                  ...
                                  <tbody>
                                   <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM verifikasi_prodrm order by id_produk desc");
					   $no++;
                    ...
                    ?>
                                    <tr align="left">
                                      ...
                                      <td align="left" style="text-align: center"><?php echo "$r[nama_vendor]"?></td>
...
";    
					...
					<div class="form-group">Nama Vendor
                      <input readonly class="form-control" id="nama_vendor" name="nama_vendor" required data-fv-notempty-message="Tidak boleh kosong">
					</div>	
					  ...
					  <input readonly class="form-control" id="sisajumlah_barang1" name="sisajumlah_barang1"  required data-fv-notempty-message="Tidak boleh kosong" >
					...
					<div>
					  <input type="text"  class="form-control" id="jumlah_barangdatang1" name="jumlah_barangdatang1" onKeyUp="sum();" placeholder="input jumlah barang kedatangan (SAK)">
					...
					<input type="date" class="form-control" id="tgl_datang1" name="tgl_datang1" placeholder="yymmdd" onKeyUp="sum();" >
					  </div>
					</div>
					<p>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
					...
					<div><label> Jumlah Barang yang dibeli (SAK)2</label>
					  ...
					  <input readonly class="form-control" id="sisajumlah_barang2" name="sisajumlah_barang2" >
					  <label>Jumlah Barang yang dibeli (KG)2</label>
					  <input readonly class="form-control" id="jumlah_kg2" name="jumlah_kg2" onKeyUp="sum();">
					  <label>Jumlah Barang yang belum diterima (KG)2</label>
					  <input readonly class="form-control" id="sisajumlah_perkilo2" name="sisajumlah_perkilo2"   onKeyUp="sum();">
					  <label>Berat Per Barang2</label>
					  <input readonly class="form-control" id="jumlah_perkilo2" name="jumlah_perkilo2" onKeyUp="sum();">
					<input type="text"  class="form-control" id="jumlah_barangdatang2" name="jumlah_barangdatang2"  onKeyUp="sum();" placeholder="input jumlah barang kedatangan (SAK)">
					  <input readonly  class="form-control" id="total_beratdatang2" name="total_beratdatang2"     onKeyUp="sum();" placeholder="Jumlah Berat Kedatanagn (KG)">
					<input type="date" class="form-control" id="tgl_datang2" name="tgl_datang2" onKeyUp="sum();" placeholder="Input Tanggal Kedatangan">
					  </div>
					  </div>
					  <p>--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
					...
					<div><label> Jumlah Barang yang dibeli (SAK)3</label>
					  ...
					  <input readonly class="form-control" id="sisajumlah_barang3" name="sisajumlah_barang3"  >
					  <label>Jumlah Barang yang dibeli (KG)3</label>
					  <input readonly class="form-control" id="jumlah_kg3" name="jumlah_kg3" onKeyUp="sum();">
					  <label>Jumlah Barang yang belum diterima (KG)3</label>
					  <input readonly class="form-control" id="sisajumlah_perkilo3" name="sisajumlah_perkilo3"   onKeyUp="sum();">
					  <label>Berat Per Barang3</label>
					  <input readonly class="form-control" id="jumlah_perkilo3" name="jumlah_perkilo3"  onKeyUp="sum();">
					  <input type="text"  class="form-control" id="jumlah_barangdatang3" name="jumlah_barangdatang3" onKeyUp="sum();" placeholder="input jumlah barang kedatangan (SAK)">
					  <input readonly  class="form-control" id="total_beratdatang3" name="total_beratdatang3"     onKeyUp="sum();" placeholder="Jumlah Berat Kedatanagn (KG)">
					<input type="date" class="form-control" id="tgl_datang3" name="tgl_datang3" placeholder="yymmdd" onKeyUp="sum();" >
					  </div>
