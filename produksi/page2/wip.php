...
<section class="content">
    ...
    <div class="box-header">
       <a href="?pg=wip&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Laporan WIP</i>
		</button> </a>   
    </div><!-- /.box-header -->
              ...
              <div class="box box-info">
                  ...
                  <table width="995" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    ...
                    ?>
						...
						<td style="text-align: center"><?php echo "$r[tgl_drying]"?></td>
...
";    
                    ...
                    <input readonly class="form-control" id="shift_drying" name="shift_drying"  >
                      ...
                      <input type="text" class="form-control" id="nm_fg" name="nm_fg" type="text" required data-fv-notempty-message="Tidak boleh kosong" />
                    </div>
                  ...
                  <select class="form-control select2" id= "ubah" name="ubah" style="width: 100%;" required data-fv-notempty-message="Tidak boleh kosong">
                      ...
                      <?php
                      $tampil=mysql_query("SELECT * FROM ppic_form ");
                      while($r=mysql_fetch_array($tampil)){
                      ?>
