    ...
    <div class="box-header">
              ...
              <div class="box box-info">
                  ...
                  <table width="995" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    ...
                    <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM sisaracikan where sisa >0");
            		 $no = 1;
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
	   if  ($_POST['sisa']>='0'){ 
		 ...
		 echo "<script> alert('data berhasil disimpan dan Sisa Racikan Terpotong !');window.location='home.php?pg=sisaracikan&act=view'</script>";
		  }else {
                ...
                <form name="form1" role="form" method = "POST" action="">
				  ...
				  <div class="form-group">Tanggal Mixing
				   ...
				   <div class="form-group">Shift mixing
                      <input type="text" maxlength="1" class="form-control" id="shift" name="shift"  required data-fv-notempty-message="Tidak boleh kosong" >
                    </div>
				   ...
				   <div class="form-group">Jumlah Target Drying (Zak)
