	...
	?>
        ...
        <table width="367" border="0">
          <tbody>
            <?php
					include("indo.php");
                    $tampil=mysql_query("SELECT * FROM planingprod where plan_prod='$_GET[plan_prod]'");
            	 $no = 1;
        ...
        <table width="367" border="0">
          <tbody>
            <?php
                    ...
                    $tampil=mysql_query("SELECT * FROM lapprod where plan_prod='$_GET[plan_prod]'");
            	 $no = 1;
			       $r=mysql_fetch_array($tampil);{
        ...
        <table rules="all" width="684" border="1">
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo "$r[aktualroti]"?></td>
              <td><?php echo "$r[shift]"?></td>
               <td><?php echo "$r[tgl]"?></td>
               <td><?php echo "$r[berita]"?></td>
        ...
        <table rules="all" width="684" border="1">
          <tbody>
            <?php
                    ...
                    $tampil=mysql_query("SELECT * FROM lapdry where plan_prod='$_GET[plan_prod]'");
            	 $no = 1;
			       $r=mysql_fetch_array($tampil);{
            ...
            <tr style="text-align: center">
              ...
              <td width="43" style="text-align: center">Target Drying</td>
				<td width="45" style="text-align: center">Aktual Fg</td>
				<td width="62" style="text-align: center">Shift</td>
