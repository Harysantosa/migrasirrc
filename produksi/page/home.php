...
<html>
  <head>
    ...
    <title> PRODUKSI // SIP| PT Raja Roti Cemerlang</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <li class="header">Master Data Manajemen Produksi</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i>
                <span>Manajemen Produksi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
				
                <li><a href="?pg=planingprod&act=view"><i class="fa fa-check-square-o"></i>Planing Produksi</a></li>
                <li><a href="?pg=dataprod&act=view"><i class="fa fa-check-square-o"></i>Laporan Produksi Roti</a></li>
                <li><a href="?pg=laporan_drying&act=view"><i class="fa fa-check-square-o"></i>Laporan Drying FG</a></li>
				<li><a href="?pg=sisaracikan&act=view"><i class="fa fa-check-square-o"></i>Sisa Racikan</a></li>
        <li><a href="?pg=sisadrying&act=view"><i class="fa fa-check-square-o"></i>Sisa Drying</a></li>
