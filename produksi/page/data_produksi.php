...
<section class="content">
    ...
    <div class="box-header">
       <a href="?pg=dataprod&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Laporan Produksi</i>
		 ...
		 <a href="cetaklapprod.php"> <button type="button" class="btn btn-info"><i class = "fa fa-print"> Cetak Detail Laporan Produksi</i>
              ...
              <th width="95" style="text-align: center">Sisa Drying</th>
    ...
    <!-- /.row (main row) -->
      ...
      if (isset($_POST['add'])) {
                ...
                $query = mysql_query("INSERT INTO lapprod VALUES ('','$_POST[no_lap]','$_POST[plan_prod]','$_POST[tgl]','$_POST[shift]','$_POST[nm_fg]','$_POST[lot]','$_POST[aktualroti]','$_POST[sisa]','$_POST[jumlah]','$_POST[fg]','$_POST[sisa_drying]','$_POST[prosentase]','$_POST[tgl_drying]','$_POST[shift_drying]','$_POST[berita]')"); 
...
var result7 = parseInt(txt13)*3.3;
	if (!isNaN(result7)) {
...
document.getElementById('sisa').value = result8;
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM lapprod WHERE id='$_GET[id]'"));
        ...
        $query = mysql_query("INSERT INTO sisadrying VALUES ('','$_POST[no_lap]','$_POST[plan_prod]','$_POST[shift_drying]','$_POST[nm_fg]','$_POST[jumlah]','$_POST[fg]','$_POST[sisa_drying]','$_POST[aktual_drying]','$_POST[prosentase]','$_POST[tgl_drying]','$_POST[berita]')");
				...
				shift='$_POST[shift]', nm_fg='$_POST[nm_fg]', lot='$_POST[lot]',  aktualroti='$_POST[aktualroti]',
				 sisa='$_POST[sisa]', jumlah='$_POST[jumlah]', fg='$_POST[fg]',sisa_drying='$_POST[sisa_drying]', prosentase='$_POST[prosentase]',  
              ...
              <div class="box box-info">
				...
				<div class="form-group">
				   ...
				   <div class="form-group">Sisa Racikan (batch)
                      ...
                      <div class="form-group">sisa drying
					  <input type="text" class="form-control" id="sisa_drying" name="sisa_drying" onKeyUp="sum();">
                      </div>
...
var txt12=document.getElementById('sisa_drying').value;
...
if (!isNaN(result7)) {
document.getElementById('sisa_drying').value = result7;
}
