...
<section class="content">
    ...
    <a href="?pg=stokrm&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data Bahan Baku</i></button> </a>
    </div><!-- /.box-header -->
                  ...
                  <table width="788"  class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
                        ...
                        <th width="285" style="text-align: left">Kode Barang</th>
						<th width="402" style="text-align: left">Nama Barang </th>
						  <th width="66"  style="text-align: left">Stok</th>
						  <th width="234" style="text-align: center">Edit</th>
                        <th width="76" style="text-align: center">Hapus</th>
					  </tr>
                    </thead>
					
                    <tbody>
                    <?php
                    $tampil=mysql_query("SELECT * FROM stok_rm order by no asc");
                    $no1 = 1;
                      while ($r=mysql_fetch_array($tampil)){
                    ?>
                        <tr>
                        <td style="text-align: left"><?php echo "$no1"?></td>
						<td style="text-align: left"><?php echo "$r[id_rm]"?></td>
						<td style="text-align: left"><?php echo "$r[nm_rm]"?></td>
						<td style="text-align: left"><?php echo "$r[stok]"?></td>
						<td style="text-align: center"><a href="?pg=stokrm&act=edit&no=<?php echo $r['no']?>">
                        <button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td style="text-align: center"><a href="?pg=stokrm&act=delete&no_rm=<?php echo $r['no']?>">
                        <button type="button" class="btn btn-danger" onClick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button>
                                      </a></td>
                                    </tr>
						<?php
                    $no1++;
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <input type="text" class="form-control" id="id_rm" name="id_rm" placeholder="Nama Vendor" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['id_rm'];?>">
                    </div>
