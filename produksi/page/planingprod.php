...
<section class="content">
    ...
    <div class="box-header">
            ...
            <td><?php echo "$r[no_form]"?></td>
						...
						<td><a href="cetak_lapprod.php?plan_prod=<?php echo $r['plan_prod']?>"> <button type="button" class="btn bg-blue">
						<i class="fa fa-print" target=_blank></i></button></a></td>
  ...
  <?php
      ...
      if (isset($_POST['add'])) {		  
                // $query = mysql_query("INSERT INTO planingprod VALUES ('','$_POST[plan_prod]','$_POST[no_form]'
                // ,'$_POST[nm_fg]','$_POST[tgl]','$_POST[shift]','$_POST[leader]','$_POST[lot]','$_POST[jumlah]'
                // ,'$_POST[screen]','$_POST[nm_cust]','$_POST[terigua]','$_POST[jmlt1]','$_POST[terigub]','$_POST[jmlt2]'
                // ,'$_POST[r1]','$_POST[jml1]','$_POST[r2]','$_POST[jml2]','$_POST[r3]','$_POST[jml3]','$_POST[r4]'
                // ,'$_POST[jml4]','$_POST[r5]','$_POST[jml5]','$_POST[r6]','$_POST[jml6]','$_POST[r7]','$_POST[jml7]'
                // ,'$_POST[r8]','$_POST[jml8]','$_POST[r9]','$_POST[jml9]','$_POST[r10]','$_POST[jml10]','$_POST[r11]'
                // ,'$_POST[jml11]','$_POST[r12]','$_POST[jml12]','$_POST[r13]','$_POST[jml13]','$_POST[r14]'
                // ,'$_POST[jml14]','$_POST[r15]','$_POST[jml15]','$_POST[r16]','$_POST[jml16]','$_POST[r17]','$_POST[jml17]'
                // ,'$_POST[r18]','$_POST[rm18]','$_POST[r19]','$_POST[rm19]','$_POST[r20]','$_POST[rm20]','$_POST[status]')");
		  
		 		        $query = mysql_query("INSERT INTO gudangrm VALUES ('','$_POST[plan_prod]','$_POST[no_form]'
                ,'$_POST[nm_fg]','$_POST[tgl]','$_POST[shift]','$_POST[leader]','$_POST[lot]','$_POST[jumlah]'
                ,'$_POST[screen]','$_POST[nm_cust]','$_POST[terigua]','$_POST[jmlt1]','$_POST[terigub]','$_POST[jmlt2]'
                ,'$_POST[r1]','$_POST[jml1]','$_POST[r2]','$_POST[jml2]','$_POST[r3]','$_POST[jml3]','$_POST[r4]'
                ,'$_POST[jml4]','$_POST[r5]','$_POST[jml5]','$_POST[r6]','$_POST[jml6]','$_POST[r7]','$_POST[jml7]'
                ...
                ,'$_POST[jml11]','$_POST[r12]','$_POST[jml12]','$_POST[r13]','$_POST[jml13]','$_POST[r14]'
                ,'$_POST[jml14]','$_POST[r15]','$_POST[jml15]','$_POST[r16]','$_POST[jml16]','$_POST[r17]','$_POST[jml17]'
                ,'$_POST[r18]','$_POST[rm18]','$_POST[r19]','$_POST[rm19]','$_POST[r20]','$_POST[rm20]','$_POST[ket]')");
		  
                mysql_query("UPDATE ppic_plan SET ppic_id='$_POST[ppic_id]',no_form='$_POST[no_form]'
                ,plan_prod='$_POST[plan_prod]', nm_fg='$_POST[nm_fg]',tgl='$_POST[tgl]',shift='$_POST[shift]'
                ,leader='$_POST[leader]',lot='$_POST[lot]',jumlah='$_POST[jumlah]',screen='$_POST[screen]'
                ,nm_cust='$_POST[nm_cust]',terigua='$_POST[terigua]',jmlt1='$_POST[jmlt1]',terigub='$_POST[terigub]'
                ,jmlt2='$_POST[jmlt2]', r1='$_POST[r1]',jml1='$_POST[jml1]',r2='$_POST[r2]',jml2='$_POST[jml2]'
                ,r3='$_POST[r3]',jml3='$_POST[jml3]',r4='$_POST[r4]',jml4='$_POST[jml4]', r5='$_POST[r5]'
                ,jml5='$_POST[jml5]',r6='$_POST[r6]',jml6='$_POST[jml6]', r7='$_POST[r7]',jml7='$_POST[jml7]'
                ,r8='$_POST[r8]',jml8='$_POST[jml8]',r9='$_POST[r9]',jml9='$_POST[jml9]',r10='$_POST[r10]'
                ,jml10='$_POST[jml10]', r11='$_POST[r11]',jml11='$_POST[jml11]', r12='$_POST[r12]',jml12='$_POST[jml12]'
                ,r13='$_POST[r13]',jml13='$_POST[jml13]',r14='$_POST[r14]',jml14='$_POST[jml14]',r15='$_POST[r15]'
                ,jml15='$_POST[jml15]',r16='$_POST[r16]',jml16='$_POST[jml16]',r17='$_POST[r17]', jml17='$_POST[jml17]'
                ,r18='$_POST[r18]',rm18='$_POST[rm18]',r19='$_POST[r19]',rm19='$_POST[rm19]',r20='$_POST[r20]'
                ,rm20='$_POST[rm20]',status='$_POST[status]' WHERE id='$_POST[id]'");
  ...
  <div class="row">
    <div class="col-md-12">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
				   ...
				   <div class="form-group">
                    ...
                    <input readonly class="form-control" id="jml15" name="jml15" value="<?php echo $d['jml15'];?>">
					</div>
					
					 <div class="form-group">
					<input readonly class="form-control" id="r16" name="r16" value="<?php echo $d['r16'];?>">
                    <input readonly class="form-control" id="jml16" name="jml16" value="<?php echo $d['jml16'];?>">
					</div>
					
					<div class="form-group">
					<input readonly class="form-control" id="r17" name="r17" value="<?php echo $d['r17'];?>">
                    <input readonly class="form-control" id="jml17" name="jml17" value="<?php echo $d['jml17'];?>">
					</div>
          ...
          <div class="form-group">
                    ...
                    <input readonly class="form-control" id="rm19" name="rm19" value="<?php echo $d['rm19'];?>">
					</div>
