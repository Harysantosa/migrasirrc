      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header">Master Data PPIC</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i>
                <span>Manajemen PPIC</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?pg=ppicform&act=view"><i class="fa fa-check-square-o"></i> Formula PPIC</a></li>
                <li><a href="?pg=ppic&act=view"><i class="fa fa-check-square-o"></i> Weekly Plan Schedule</a></li>
				 <li><a href="?pg=dataprod&act=view"><i class="fa fa-check-square-o"></i>Laporan Produksi</a></li>
				 
				</ul>
<li class="header">Tambah Data Customer</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i>
                <span>Data Customer</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
