    ...
    <div class="box-header">
       <a href="?pg=dataprod&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Laporan Produksi</i>
              ...
              <div class="box box-info">
                  ...
                  <table width="445" height="73" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center"><a href="?pg=dataprod&act=edit&id=<?php echo $r['id']?>">
                         <button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button>
							...
							<td><a href="?pg=dataprod&act=delete&id=<?php echo $r['id']?>"><button  type="button" class="btn btn-danger" onClick="return confirm('Anda akan menghapus data planing Poduksi <?php echo $r['no_plan']?>');"><i class = "fa fa-trash-o"></i></button></i></button></a></td>
