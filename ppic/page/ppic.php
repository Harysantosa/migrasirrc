              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<div class="form-group">
                      <label for="exampleInputEmail1">No Form</label>
...
";    
                ...
                ?>
				  ...
				  <div class="form-group">
		                  ...
		                  <input readonly class="form-control" id="rm16" name="rm16" onKeyUp="sum();" >
                ...
                ?>
					...
					<input readonly class="form-control" id="rm18" name="rm18" onKeyUp="sum();" >
				  ...
				  <select class="form-control select2" id="r19" name="r19" style="width: 100%;" required data-fv-notempty-message="Tidak boleh kosong" >
					...
					<!--<input readonly class="form-control" id="r17" name="r17" value="hd polos 80x50x70m">-->
                     <input readonly class="form-control" id="rm19" name="rm19" onKeyUp="sum();">
                      ...
                      <input type readonly class="form-control" id="rm20" name="rm20"  onKeyUp="sum();" >
                    </div>
                    <div class="form-group">Status                
                      <input type readonly class="form-control" id="status" name="status" placeholder="Input Jumlah Batch" required data-fv-notempty-message="Tidak boleh kosong" onKeyUp="sum();"  value="<?php echo $d['status'];?>"  >
                    </div>			
