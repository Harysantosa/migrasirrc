...
<div class="content-wrapper">
        ...
        <h1>Data PPIC </h1>
            ...
            <li class="active"><a href="?pg=pggna&act=view">PPIC Produksi  
             </ol>
        </section>
...
<thead>
	...
	$d = mysql_fetch_array(mysql_query("SELECT * FROM formula_new WHERE no='$_GET[no]'"));
      ...
      if (isset($_POST['add'])) {		  
                $query = mysql_query("INSERT INTO ppic_plan VALUES ('','$_POST[ppic_id]','$_POST[plan_prod]','$_POST[nm_fg]','$_POST[tgl]','$_POST[mixer]'
				  ...
				  <div class="form-group">Kode Planing Produksi
                    ...
                    <input name="mixer" type="radio" value="1"> Mixer 1 
					 <input name="mixer" type="radio" value="2"> Mixer 2 
					  <input name="mixer" type="radio" value="3"> Mixer 3
					   <input name="mixer" type="radio" value="3"> Mixer 4
					    <input name="mixer" type="radio" value="3"> Mixer 5
					</div>
                    ...
                    <input name="oven" type="radio" value="OB1"> OB1 
					 <input name="oven" type="radio" value="OB2"> OB2 
					  <input name="oven" type="radio" value="OB3"> OB3
						<input name="oven" type="radio" value="OB3"> OB4
                    ...
                    <input name="dd" type="radio" value="1"> DD 1 
					 <input name="dd" type="radio" value="2"> DD 2 
					  <input name="dd" type="radio" value="3"> DD 3
                    ...
                    <input name="leader" type="radio" value="A//ROHIMIN"> Rohimin <br>
					 <input name="leader" type="radio" value="B//HAMID"> Hamid <br>
					  <input name="leader" type="radio" value="C//MUKLIS"> Muklis <br>
						<input name="leader" type="radio" value="D//..."> ... <br>
					</div>
					...
					<script type="text/javascript">    
						 ...
						 function sum() {
							...
							var result16 = (parseFloat(txt16)*parseFloat(txt15)) ;
      						if (!isNaN(result16)) {
         					document.getElementById('jmlt1').value = result16.toFixed(2);
							}
							
							var result17 = (parseFloat(txt17)*parseFloat(txt15)) ;
      						if (!isNaN(result17)) {
         					document.getElementById('jmlt2').value = result17.toFixed(2);
							}
							
							var result18 = (parseFloat(txt15)*3.2) ;
      						if (!isNaN(result18)) {
         					document.getElementById('rm15').value = result18.toFixed(0);
							}
							...
							var result20 = (parseFloat(txt15)*3.2) ;
      						if (!isNaN(result20)) {
         					document.getElementById('rm17').value = result20.toFixed(0);
							}
							
							var result21 = (parseFloat(txt15)*3.2) ;
      						if (!isNaN(result21)) {
         					document.getElementById('rm18').value = result21.toFixed(0);
							}
