                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                       ...
                       <td><a href="?pg=admin&act=delete&id=<?php echo $r['id_user']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
							 <td><a href="?pg=admin&act=edit&id=<?php echo $r['id_pr/']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        </tr>
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="radio" name="status" id="status" value="Ya" required data-fv-notempty-message="Tidak boleh kosong"> Ya 
                      </label>
                      <label class="radio-inline">
                      <input type="radio" name="status" id="status" value="Tidak" required data-fv-notempty-message="Tidak boleh kosong"> Tidak
                      </label>
                    </div>
                  </div><!-- /.box-body -->
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM users WHERE id_user='$_GET[id]'"));
            ...
            if (empty($_POST[password])) {
                ...
                mysql_query("UPDATE users SET username='$_POST[username]',
                  status='$_POST[status]' WHERE id_user='$_POST[id]'");
                echo "<script>window.location='?pg=admin&act=view'</script>";
            } else {
              mysql_query("UPDATE users SET username='$_POST[username]', 
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      ?>
                      <label class="radio-inline">
                      <input type="radio" name="status" id="status" value="Ya" required data-fv-notempty-message="Tidak boleh kosong" checked> Ya 
                      </label>
                      <label class="radio-inline">
                      <input type="radio" name="status" id="status" value="Tidak" required data-fv-notempty-message="Tidak boleh kosong"> Tidak
                      </label>
                      ...
                      <label class="radio-inline">
                      <input type="radio" name="status" id="status" value="Tidak" required data-fv-notempty-message="Tidak boleh kosong" checked> Tidak
                      </label>
                      <?php
                      }
                      ?>
