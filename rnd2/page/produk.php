...
include("indo.php");
                    ...
                    ?>
						...
						<td><a href="?pg=produk&act=edit1&id_produk=<?php echo $r['id_produk']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysql_query("INSERT INTO produk VALUES ('','$_POST[no_po]','$_POST[no_inv]','$_POST[nama_vendor]','$_POST[alamat]','$_POST[kota]','$_POST[telepon]','$_POST[pic]','$_POST[nama_rm1]','$_POST[jumlah_barang1]','$_POST[jumlah_kg1]','$_POST[jumlah_perkilo1]','$_POST[sisajumlah_barang1]','$_POST[sisajumlah_perkilo1]','$_POST[nama_rm2]','$_POST[jumlah_barang2]','$_POST[jumlah_kg2]','$_POST[jumlah_perkilo2]','$_POST[sisajumlah_barang2]','$_POST[sisajumlah_perkilo2]','$_POST[nama_rm3]','$_POST[jumlah_barang3]','$_POST[jumlah_kg3]','$_POST[jumlah_perkilo3]','$_POST[sisajumlah_barang3]','$_POST[sisajumlah_perkilo3]','$_POST[tglmasuk]')");
		  
		        $query .= mysql_query("INSERT INTO produkrm VALUES ('','$_POST[no_po]','$_POST[nama_vendor]','$_POST[nm_rm]','$_POST[jumlah_barang]','$_POST[jumlah_perkilo]','$_POST[jumlah_kg]','$_POST[tglmasuk]','$_POST[tgldatang]')");
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="nama_vendor" id="nama_vendor" onchange="changeValue(this.value)" >
                ...
                ?>
                      ...
                      <input readonly class="form-control" id="jumlah_kg3"name="jumlah_kg3"   placeholder="Total (KG)" onKeyUp="sum();" >
					   ...
					   <input type="hidden"class="form-control" id="sisajumlah_barang3" name="sisajumlah_barang3" placeholder="Jumlah Berat Satuan Barang" onKeyUp="sum();" >
						...
						var txt2 = document.getElementById('jumlah_perkilo1').value;
						var txt3 = document.getElementById('jumlah_kg1').value;
						var txt4 = document.getElementById('sisajumlah_perkilo1').value;
						var txt5 = document.getElementById('sisajumlah_barang1').value;
							
						var txt6  = document.getElementById('jumlah_barang2').value;
						var txt7  = document.getElementById('jumlah_perkilo2').value;
						var txt8  = document.getElementById('jumlah_kg2').value;
						var txt9  = document.getElementById('sisajumlah_perkilo2').value;
						var txt10 = document.getElementById('sisajumlah_barang2').value;	
						
						var txt11 = document.getElementById('jumlah_barang3').value;
						var txt12 = document.getElementById('jumlah_perkilo3').value;
						var txt13 = document.getElementById('jumlah_kg3').value;
						var txt14 = document.getElementById('sisajumlah_perkilo3').value;
						var txt15 = document.getElementById('sisajumlah_barang3').value;
												
														
						var result1 = parseInt(txt1) * parseInt(txt2);
      					if (!isNaN(result1)) {
         				document.getElementById('jumlah_kg1').value = result1;
						}
																					
						var result2 = parseInt(txt6) * parseInt(txt7);
      					if (!isNaN(result2)) {
         				document.getElementById('jumlah_kg2').value = result2;
						}
						
						var result3 = parseInt(txt11) * parseInt(txt12);
      					if (!isNaN(result3)) {
         				document.getElementById('jumlah_kg3').value = result3;
						}
																								
																		
						var result8 = parseInt(txt3) + (0);
      					if (!isNaN(result8)) {
         				document.getElementById('sisajumlah_perkilo1').value = result8;
						}
						
						var result9 = parseInt(txt1) + (0);
      					if (!isNaN(result9)) {
         				document.getElementById('sisajumlah_barang1').value = result9;
						}
						
						var result10 = parseInt(txt8) + (0);
      					if (!isNaN(result10)) {
         				document.getElementById('sisajumlah_perkilo2').value = result10;
						}
						
						var result11 = parseInt(txt6) + (0);
      					if (!isNaN(result11)) {
         				document.getElementById('sisajumlah_barang2').value = result11;
						}
							
						var result12 = parseInt(txt13) + (0);
      					if (!isNaN(result12)) {
         				document.getElementById('sisajumlah_perkilo3').value = result12;
						}
						
						var result13 = parseInt(txt11) + (0);
      					if (!isNaN(result13)) {
         				document.getElementById('sisajumlah_barang3').value = result13;
						}	
