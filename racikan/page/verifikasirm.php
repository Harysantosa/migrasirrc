...
<div class="content-wrapper">
        <!-- Content Header (Page header) -->
        <section class="content-header">
        <h1> Tambah Data Verifikasi RM IN</h1>
            <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="">Data Verifikasi RM</a></li>
            <li class="active">Tambah Data Verifikasi RM</li>
             </ol>
        </section>
              ...
              <div class="box box-info">
                ...
                <form name="form1" role="form" method = "POST" action="">
                  <div class="box-body">
					...
					<?php 
					$result = mysql_query("select * from produk group by id_produk desc");    
