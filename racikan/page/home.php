...
<html>
  <head>
    ...
    <title> RACIKAN // SIP| PT Raja Roti Cemerlang</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
               <li><a href="?pg=verifikasipremix&act=view"><i class="fa fa-check-square-o"></i>Buat Planing Produksi Premix</a></li>
			     <li><a href="?pg=planpremix&act=view"><i class="fa fa-check-square-o"></i>Data Produksi Premix</a></li>
				  <li><a href="?pg=laporanpremix&act=view"><i class="fa fa-check-square-o"></i>Laporan Produksi Premix</a></li>
