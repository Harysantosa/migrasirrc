...
<section class="content">
    ...
    <a href="cetak_laporanbayarhutang.php" target="_blank"> <button type="button" class="btn btn-info" ><i class="fa fa-print" target=_blank>Print Data Laporan pembayaran hutang</i></button> 
		</a>  
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <th style="text-align: center">No</th>
						 ...
						 <th style="text-align: center">NO Invoice</th>
						  ...
						  <th style="text-align: center">Tanggak Kedatangan Barang</th>
                    ...
                    <?php
				    include("indo.php");
                    $tampil=mysql_query("SELECT * FROM pembayaran_hutang order by id asc");
                    $no = 1;
                    ...
                    ?>
						...
						<td style="text-align: center"><?php echo TanggalIndo($r['tgl_byr'])?></td>
                       <td style="text-align: center"><?php echo "$r[nama]"?></td>
					 <td style="text-align: center"><?php echo "Rp. ". number_format("$r[sisa1_hutang]",'0','.','.')?></td>
						 <td style="text-align: center"><?php echo "Rp. ". number_format("$r[nominal]",'0','.','.')?></td>
					  ...
					  <td style="text-align: center"><?php echo TanggalIndo($r['jatuh_tempo'])?></td>
						  ...
						  <td><a href="?pg=pembayaran_hutang&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysql_fetch_array(mysql_query("SELECT * FROM pembayaran_hutang WHERE id='$_GET[id]'"));
	
            if (isset($_POST['update'])) {
				
				
				mysql_query("UPDATE pembayaran_piutang SET no_byr='$_POST[no_byr]', tgl_kirim='$_POST[tgl_kirim]', tgl_bayar='$_POST[tgl_bayar]',nama='$_POST[nama_vendor]', piutang'$_POST[piutang]', sisa_piutang='$_POST[sisa_piutang]', no_inv='$_POST[no_inv]', tempo='$_POST[tempo]', no_rek='$_POST[no_rek]', nama_bank='$_POST[nama_bank]', saldo='$_POST[saldo]', nominal='$_POST[nominal]', metode_pembayaran='$_POST[metode_pembayaran]' WHERE id='$_POST[id]'");
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA transaksi //
      case 'delete':
      mysql_query("DELETE FROM pembayaran_hutang WHERE id='$_GET[id]'");
      echo "<script>window.location='home.php?pg=pembayaran_hutang&act=view'</script>";
      break;
