...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>Saldo masuk Petty Cash</h1>
        <ol class="breadcrumb">
          <li><a href=""><i class="fa fa-dashboard"></i> Beranda</a></li>
          <li class="active">Data Vendor
        </ol>
      </section>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box-header">
              <a href="?pg=saldopettycash&act=add"> <button type="button" class="btn btn-info"><i class="fa fa-plus"> Tambah Saldo Petty Cash</i></button> </a>
              <?php
                ...
                <div class="table-responsive">
                  <table width="98%" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%;">
                    <thead>
                      <tr>
                        <th width="150">No</th>
                        <th width="399">No Transaksi</th>
                        <th width="405">Total Pengisisan Saldo</th>
                        <th width="405">Tanggal Pengisisan Saldo</th>
                        <th width="105">Hapus Saldo</th>
                    ...
                    <tbody>
                      <?php
                      include("indo.php");
                      $tampil = mysql_query("SELECT * FROM saldo_pettycash GROUP by id ");
                      $no = 1;
                      while ($r = mysql_fetch_array($tampil)) {
                      ?>
                        <tr>
                          <td><?php echo "$no" ?></td>
                          <td><?php echo "$r[no_byr]" ?></td>
                          <td><?php echo "Rp." . number_format("$r[saldo_in]", '0', '.', '.') ?></td>
                          <td><?php echo "$r[tgl]" ?></td>
                          <td><a href="?pg=saldopettycash&act=deletesaldopettycash&id=<?php echo $r['id'] ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class="fa fa-trash-o"></i></button></a></td>
                        </tr>
  ...
  case 'add':
    if (isset($_POST['add'])) {
      $query .= mysql_query("INSERT INTO saldo_pettycash VALUES ('','$_POST[no_byr]','$_POST[saldo_in]','$_POST[tgl]')");



      echo "<script>window.location='home.php?pg=saldopettycash&act=view'</script>";
    }
  ?>
              ...
              <div class="box-body">
                ...
                <form name="form1" role="form" method="POST" action="">
                  <div class="box-body">
                    ...
                    $sql = mysql_query("select * from saldo_pettycash");
                    ...
                    $tahun = date('m/Y');
                    $kode_jadi = "SALDO/$tahun/$bikin_kode";
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" id="saldo_in" name="saldo_in" onKeyUp="sum();" placeholder="Input Nama Bank">
                    </div>

                    <div class="form-group">
                      <input type="date" class="form-control" id="tgl" name="tgl" onKeyUp="sum();" placeholder="input no rekening bank">
                    </div>
...
";
    ...
    <?php
      ...
      case 'delete':
        ...
        break;
      case 'deletesaldopettycash':
        mysql_query("DELETE FROM saldo_pettycash where id='$_GET[id]'");
        echo "<script>window.location='home.php?pg=saldopettycash&act=view'</script>";
    }
    ?>
