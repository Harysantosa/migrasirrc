                  ...
                  <table width="445" height="73" class="table table-bordered table-striped" id="example1" style="width: 100%">
                    ...
                    ?>
									...
									<td align="center" style="text-align: center"><?php echo "$r[tgl_datang1]"?></td>
									  <td><a href=""><button type="button" class="btn btn-danger" onClick="return confirm('Mohon Verifikasi Terlebih dahulu ke bagian gudang jika anda ingin menghapus data planing Produksi <?php echo $r['no_po']?>');"><i class = "fa fa-trash-o"></i></button></i></button></a></td>
