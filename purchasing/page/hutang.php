...
<section class="content">
    ...
    <div class="box-header">
      <a href="cetak_laporanhutang.php" target="_blank"> <button type="button" class="btn btn-info" ><i class="fa fa-print" target=_blank>Print Data Laporan hutang</i></button> 
		</a>
			...
			<h2 align="left">Saldo Bank BCA <?php echo "Rp. ". number_format("$d[saldo]",'0','.','.')?></h2>
              ...
              <div class="box box-primary">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					include("indo.php");
                     $tampil=mysql_query("SELECT *,DATE_ADD(tglmasuk,interval jatuh_tempo DAY) as jatuh_tempo FROM hutang group by id_produk");
                    $no = 1;
                    ...
                    ?>
                        ...
                        <td style="text-align: center"><?php echo TanggalIndo($r['tglmasuk'])?></td>
                         ...
                         <td style="text-align: center"><a href="?pg=hutang&act=add1&id_produk=<?php echo $r['id_produk']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
							 <td style="text-align: center"><a href="?pg=hutang&act=edit&id_produk=<?php echo $r['id_produk']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td style="text-align: center"><a href="?pg=hutang&act=delete&id_produk=<?php echo $r['id_produk']?>"><button type="button" class="btn btn-primary" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
                        </tr>
                    ...
                    ?>
                     ...
                     <tr>
                               ...
                               $liatHarga=mysql_fetch_array(mysql_query("SELECT sum(sisa_hutang) as total_hutang FROM hutang where id_produk")); ?>
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'add1':
      $d = mysql_fetch_array(mysql_query("SELECT * FROM hutang WHERE id_produk='$_GET[id_produk]'"));
            if (isset($_POST['add1'])) {
			
		 if  ($_POST['sisa1_hutang']>='0'){
		  

                $query = mysql_query("INSERT INTO pembayaran_hutang VALUES ('','$_POST[no_byr]','$_POST[tglmasuk]','$_POST[tgl_byr]','$_POST[nama]','$_POST[sisa_hutang]','$_POST[sisa1_hutang]','$_POST[no_inv]','$_POST[jatuh_tempo]','$_POST[no_rek]','$_POST[nama_bank]','$_POST[saldo]','$_POST[nominal]')");
				
               echo "<script> alert('pembayaran berhasil');window.location='home.php?pg=hutang&act=view'</script>";
              }else if  ($_POST['sisa1_hutang']>='0'){ 
			  mysql_query("DELETE FROM hutang  WHERE id_produk='$_GET[id_produk]'");
                  ...
                  <div class="box-body">
                   ...
                   <label for="exampleInputEmail1">Nomor Plan Produksi</label>
                      ...
                      <input type="hidden" class="form-control" id="no_byr" name="no_byr" placeholder="Nomor Planing" value="<?php echo $kode_jadi?>" required data-fv-notempty-message="Tidak boleh kosong">
						  <input type="hidden" class="form-control" id="id_produk" name="id_produk"   required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
					   <div class="form-group">
...
<?php
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM hutang WHERE id_produk='$_GET[id_produk]'"));
            if (isset($_POST['update'])) {
				...
				mysql_query("UPDATE hutang SET tglmasuk='$_POST[tglmasuk]', no_inv='$_POST[no_inv]', sisa_hutang='$_POST[sisa_hutang]',jatuh_tempo='$_POST[jatuh_tempo]',nama='$_POST[nama]' WHERE id_produk='$_POST[id_produk]'");
...
<section class="content">
  <div class="row">
              ...
              <div class="box box-primary">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
					   ...
					   <input type="hidden" class="form-control" id="id_produk" name="id_produk" required data-fv-notempty-message="Tidak boleh kosong" value= "<?php echo $d['id_produk'];?>">
					 ...
					 <div class="form-group">
                      ...
                      <input readonly class="form-control" id="tglmasuk" name="tglmasuk" placeholder="Nama Kas keluar" value= "<?php echo $d['tglmasuk'];?>">
						
						 <div class="form-group">
                      <label for="exampleInputEmail1">No Invoice</label>
                      <input type="text" class="form-control" id="no_inv" name="no_inv" placeholder="Nama Kas keluar" value= "<?php echo $d['no_inv'];?>">
    ...
    // PROSES HAPUS DATA transaksi //
      case 'delete':
      mysql_query("DELETE FROM hutang  WHERE id='$_GET[id]'");
      echo "<script>window.location='home.php?pg=hutang&act=view'</script>";
      break;
