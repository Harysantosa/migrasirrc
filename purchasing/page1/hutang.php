                    ...
                    ?>
                        ...
                        <td style="text-align: center"><?php echo TanggalIndo($r['tglmasuk'])?></td>
                         ...
                         <td style="text-align: center"><a href="?pg=hutang&act=add1&id=<?php echo $r['id']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
							 <td style="text-align: center"><a href="?pg=hutang&act=edit&id=<?php echo $r['id']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td style="text-align: center"><a href="?pg=hutang&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-primary" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
                        </tr>
...
<?php
      ...
      $d = mysql_fetch_array(mysql_query("SELECT * FROM hutang WHERE id='$_GET[id]'"));
            if (isset($_POST['update'])) {
				...
				mysql_query("UPDATE hutang SET tglmasuk='$_POST[tglmasuk]', no_inv='$_POST[no_inv]', sisa_hutang='$_POST[sisa_hutang]',jatuh_tempo='$_POST[jatuh_tempo]',nama_vendor='$_POST[nama_vendor]' WHERE id='$_POST[id]'");
