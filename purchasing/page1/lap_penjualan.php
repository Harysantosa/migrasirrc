      ...
      <div class="col-md-12">
                  ...
                  <div class="box box-info">
                      ...
                      <div class="table-responsive">
                        ...
                        <tbody>
                          <tr>
                            <td align = "center" colspan="5"><table class="table table-hover responsive">
                              <thead>
                                <tr>
                                  <th>No</th>
                                  <th>No Penjualan</th>
                        ...
                        ?>
                                  <td align = "center"><span style="font-weight:bold"><?php echo "". number_format("$liatHarga[itemterjual]",'0','.','.')?></span></td>
                                  <td align = "center"><span style="font-weight:bold"><?php echo "Rp.". number_format("$liatHarga[harga_produk]",'0','.','.')?></span></td>
                                  <td align = "center"><span style="font-weight:bold"><?php echo "Rp.". number_format("$liatHarga[total_penjualan]",'0','.','.')?></span></td>
                                </tr>
                              </tbody>
