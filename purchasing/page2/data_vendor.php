                  ...
                  <table width="730" height="73" class="table table-bordered table-striped" id="tabelku">
                    ...
                    ?>
						...
						<td><?php echo "$r[pic]"?></td>
							<td><a href="?pg=katalog&act=view"><button type="button" class="btn btn-danger"><i class = "fa fa-home"></i></button></a></td>
                  ...
                  <div class="box-body">
                   ...
                   <label for="exampleInputEmail1">Kode Vendor</label>
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" class="form-control" id="nama"  name="nama" placeholder="Nomor Vendor" required data-fv-notempty-message="Tidak boleh kosong" style="text-transform:uppercase">
                    </div>
