 <?php 
	...
	?>
               ...
               <title>Print Laporan Data Pembayaran Hutang</title>
                    ...
                    <form action="cetak_laporanbayarhutang.php" method="post" name="postform">
                      <table border="0">
                <tr>
        ...
        <?php
          ...
          <script language="JavaScript">
                ...
                document.location='cetak_laporanbayarhutang.php';
            </script>
            <?php
            }else{
            ?><i><b>Informasi : </b> Hasil pencarian data berdasarkan periode Tanggal <b><?php echo $_POST['tanggal_awal']?></b> s/d <b><?php echo $_POST['tanggal_akhir']?></b></i>
                               ...
                               <?php
				include("indo.php");
             $query=mysql_query("select * from pembayaran_hutang where tgl_byr between '$tanggal_awal' and '$tanggal_akhir'");
            }
        ?>
        </p>
        <table width="1480" height="82" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr bgcolor="#FF6600">
               
                <th width="48" style="text-align: center">No</th>
						
                        <th width="176" style="text-align: center">Kode Pembayaran</th>
				 <th width="256" style="text-align: center">Tanggal Bayar</th>
				 <th width="256" style="text-align: center">Nama Vendor</th>
                       	<th width="299" style="text-align: center">Jumlah Hutang</th>
                        <th width="177" style="text-align: center">Jumlah Bayar</th>
				<th width="295" style="text-align: center">Sisa Hutang</th>
            ...
            ?>
            <tr>
                <td align="left" style="text-align: center"><?php echo "$r[id]"?></td>
				<td align="left" style="text-align: center"><?php echo "$r[no_byr]"?></td>
				<td align="left" style="text-align: center"><?php echo TanggalIndo($r['tgl_byr'])?></td>
				<td align="left" style="text-align: center"><?php echo "$r[nama_vendor]"?></td>
				<td align="left" style="text-align: center"><?php echo "Rp. ". number_format("$r[sisa1_hutang]",'0','.','.')?></td> 
				<td align="left" style="text-align: center"><?php echo "Rp. ". number_format("$r[nominal]",'0','.','.')?></td>
