...
<div class="content-wrapper">
        ...
        <h1>Verifikasi PO</h1>
            ...
            <li class="active"><a href="?pg=pggna&act=view">Data Verifikasi</ol>
        </section>
              ...
              <div class="box box-info">
                  ...
                  <table width="1041" height="73" class="table table-bordered table-striped" id="example1">
                    ...
                    ?>
                        ...
                        <td><a href="?pg=verifikasipo&act=delete&id=<?php echo $r['id']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
						
						<td><a href="cetak_po.php?id=<?php echo $r['id']?>"> <button type="button" class="btn bg-orange">
