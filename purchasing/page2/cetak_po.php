...
<title>Cetak PO</title>
 <?php 
	...
	?>
<title>Cetak PO</title><table width="776" height="285" border="0">
 <?php
  ...
  <tr>
    ...
    <td colspan="3" rowspan="2"><h1 align="center" class="style2">PURCHASE ORDER</h1></td>
  </tr>
  <tr>
    <td height="73" colspan="3"><span class="style2">Kp Pulo Kendal Desa Setia Asih, Kecamatan Tarumajaya Kabupaten Bekasi</span></td>
  </tr>
  <tr>
    <td height="40" colspan="3" bgcolor="#FFFF00"><div align="center"><strong>SUPLIER DETAIL INFO </strong></div></td>
 ...
 <?php
            	 ...
            	 $no1 = 1;
			       $r1=mysql_fetch_array($tampil1);{
                    ...
                    ?>
  <tr>
    <td colspan="4" bgcolor="#0066CC"><div align="center"><strong>ORDER DETAIL </strong></div></td>
  </tr>
  <tr>
    <td bgcolor="#0066CC"><div align="left"><strong><span class="style2">NAMA BARANG </span></strong></div></td>
    <td bgcolor="#0066CC"><div align="left"><strong>JUMLAH QTY </strong></div></td>
    <td bgcolor="#0066CC"><div align="left"><strong>HARGA SATUAN </strong></div></td>
    <td bgcolor="#0066CC"><div align="left"><strong>TOTAL HARGA </strong></div></td>
  </tr>
  <tr>
    <td height="34"><?php echo "$r1[nama_rm1]"?></td>
    <td><?php echo "$r1[jumlah_barang1]"?></td>
   <td><?php echo "". number_format("$r[harga_perbarang1]")?></td>
   <td><?php echo "". number_format("$r[total1]")?></td>
  </tr>
  <tr>
    <td height="39"><?php echo "$r1[nama_rm2]"?></td>
    <td><?php echo "$r[jumlah_barang2]"?></td>
    <td><?php echo "". number_format("$r[harga_perbarang2]")?></td>
    <td><?php echo "". number_format("$r[total2]")?></td>
  </tr>
  <tr>
    <td height="30"><?php echo "$r1[nama_rm3]"?></td>
    <td><?php echo "$r[jumlah_barang3]"?></td>
    <td><?php echo "". number_format("$r[harga_perbarang3]")?></td>
    <td><?php echo "". number_format("$r[total3]")?></td>
  </tr>
    <?php
				   }
						   ?>
...
<table  width="780" height="172" border="0">
  <tr>
    <td width="208"><div align="center">Prepared By </div></td>
    <td width="184"><div align="center">Approved By </div></td>
    <td width="170"><div align="center">&nbsp;</div></td>
    <td width="250"><div align="center">Approval supplier </div></td>
  </tr>
  <tr>
    <td height="91">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="23"><div align="center">Purchasing </div></td>
    <td><div align="center">Director</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="left"><?php echo "$r[nama]"?></div></td>
  </tr>
</table>
<table width="779" height="126" border="0">
  ...
  <tr>
    <td height="97"><p>* PO Disertakan Ketika Mengirim Barang</p>
      <p>* Konformasi ketika mengirim barang</p>
    <p>* Pembayaran Dilakukan pada hari</p></td>
  </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
